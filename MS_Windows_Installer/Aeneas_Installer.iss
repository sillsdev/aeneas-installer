...
#define MyAppFileName "aeneas-windows-setup-1.7.3_1"
...
Name: "python"; Description: "Install Python 2.7.16"; ExtraDiskSpaceRequired: 106450944; Types: full compact custom; Flags: fixed
...
Name: "numpy"; Description: "Install Python Module NumPy 1.16.4"; ExtraDiskSpaceRequired: 0; Types: full compact custom; Flags: fixed
...
Source: "numpy-1.16.4-cp27-cp27m-win32.whl"; DestDir: "{app}"; Components: numpy; Flags: ignoreversion
Source: "pip-19.2.2-py2.py3-none-any.whl"; DestDir: "{app}"; Components: python; Flags: ignoreversion
Source: "python-2.7.16.msi"; DestDir: "{app}"; Components: python; Flags: ignoreversion
...
Filename: "{app}\python-2.7.16.msi"; Parameters: "/PASSIVE"; Description: "Install Python 2.7.16"; Components: python; Flags: shellexec waituntilterminated
...
Filename: "{sys}\MSIEXEC.EXE"; Parameters: "/PASSIVE /X {app}\python-2.7.16.msi"; Components: python; Flags: shellexec waituntilterminated
