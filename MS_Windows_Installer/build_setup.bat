...
IF NOT EXIST "%cd%\7z1602.exe" (
  ...
  powershell "(new-object System.Net.WebClient).DownloadFile('http://www.7-zip.org/a/7z1602.exe', '%cd%\7z1602.exe')"
)
...
IF NOT EXIST "%cd%\innosetup-5.5.9-unicode.exe" (
  ...
  powershell "(new-object System.Net.WebClient).DownloadFile('http://www.jrsoftware.org/download.php/is-unicode.exe','%cd%\innosetup-5.5.9-unicode.exe')"
)
...
IF NOT EXIST "%cd%\python-2.7.11.msi" (
  ...
  powershell "(new-object System.Net.WebClient).DownloadFile('https://www.python.org/ftp/python/2.7.11/python-2.7.11.msi', '%cd%\python-2.7.11.msi')"
)
...
echo Downloading Visual C++ For Python27...
  powershell "(new-object System.Net.WebClient).DownloadFile('https://download.microsoft.com/download/7/9/6/796EF2E4-801B-4FC4-AB28-B59FBF6D907B/VCForPython27.msi', '%cd%\VCForPython27.msi')"
)
...
echo Downloading Microsoft .NET Framework 3.5...
  powershell "(new-object System.Net.WebClient).DownloadFile('https://download.microsoft.com/download/7/0/3/703455ee-a747-4cc8-bd3e-98a615c3aedb/dotNetFx35setup.exe', '%cd%\dotNetFx35setup.exe')"
)
