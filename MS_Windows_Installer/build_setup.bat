...
cscript.exe /B wget.vbs "http://www.7-zip.org/a/7z1602.exe" "%cd%\7z1602.exe"
echo Installing 7-zip...
7z1602.exe

echo Downloading Inno Setup...
cscript.exe /B wget.vbs "http://www.jrsoftware.org/download.php/is-unicode.exe" "%cd%\innosetup-5.5.9-unicode.exe"
echo Installing InnoSetup...
innosetup-5.5.9-unicode.exe /SILENT

echo Downloading Python 2.7.11...
cscript.exe /B wget.vbs "https://www.python.org/ftp/python/2.7.11/python-2.7.11.msi" "%cd%\python-2.7.11.msi"
echo Installing Python 2.7.11...
python-2.7.11.msi /PASSIVE

echo Downloading Visual C++ For Python27...
cscript.exe /B wget.vbs "https://download.microsoft.com/download/7/9/6/796EF2E4-801B-4FC4-AB28-B59FBF6D907B/VCForPython27.msi" "%cd%\VCForPython27.msi"
